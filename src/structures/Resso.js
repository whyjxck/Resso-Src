 ...
 //       return (this.nowPlayingMessage = message);
  //    } 
      ...
      setbassboost(bassboost) {
        if (isNaN(bassboost)) {
          throw new RangeError("Player#setbassboost() bassboost must be a number.");
        }
        this.bassboost = Math.max(Math.min(bassboost, 5), 0.05);
        this.setTimescale(bassboost);
        return this;
      }
